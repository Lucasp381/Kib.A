...
export const FormSchema = z.object({
    ...
    "all_rules": z.boolean().default(true).optional(),
                                            ...
                                            <div>
                                                ...
                                                <ScrollArea className="">
                                                    ...
                                                    <div className="flex flex-col gap-4 pr-4 mb-6">
                                                                ...
                                                                <FormItem>
                                                                    ...
                                                                    <FormControl>
                                                                        <Input
                                                                            ...
                                                                            type="number"
                                                                            {...field}
                                                                            value={Number(field.value) || 587} // Default to 587 if no value is set
                                                                            onChange={(e) => field.onChange(e.target.valueAsNumber)} // ensures it's stored as number
                                                        ...
                                                        <FormField
                                                            ...
                                                            render={({ field }) => (
                                                                <FormItem>
                                                                    ...
                                                                    <FormControl>
                                                                        <Input
                                                                            placeholder="Y0ur5up3R53cr3tP@ssw0rd"
                                                                            autoComplete="false"
                                                                            type="password"
                                                                            {...field}
                                                        ...
                                                        <FormField
                                                            ...
                                                            render={({ field }) => (
                                                                <FormItem>
                                                                    ...
                                                                    <FormControl>
                                                                        <Input
                                                                            placeholder="exemple@company.com,exemple2@company.com"
                                                                            autoComplete="false"
                                                                    ...
                                                                    <FormDescription>
                                                                        TO addresses of the email (comma separated)
                                                                    </FormDescription>
                                                                    <FormMessage />
                                                                </FormItem>
                                                            )}
                                                        ...
                                                        <FormField
                                                            ...
                                                            render={({ field }) => (
                                                                <FormItem>
                                                                    ...
                                                                    <FormDescription>
                                                                        CC addresses of the email (comma separated)
                                                                    </FormDescription>
                                                                    <FormMessage />
                                                                </FormItem>
                                                            )}
                                                        ...
                                                        <FormField
                                                            control={form.control}
                                                            name="config.firedSubjectTemplate"
                                                            render={({ field }) => (
                                                                <FormItem>
                                                                    ...
                                                                    <FormDescription>
                                                                        This is the ID of the Email channel where alerts will be sent.
                                                                    </FormDescription>
                                                                    <FormMessage />
                                                                </FormItem>
                                                            )}
                                                            ...
                                                            render={({ field }) => (
                                                                <FormItem>
                                                                    ...
                                                                    <AlertersTextArea
                                                                            ...
                                                                            placeholder="Alert: issue detected in {_source.kibana.alert.rule.name}"
                                                                        />
                                                                    </FormControl>
                                                                    <FormDescription>
                                                        ...
                                                        <FormField
                                                            control={form.control}
                                                            name="config.recoveredSubjectTemplate"
                                                            render={({ field }) => (
                                                                <FormItem>
                                                            ...
                                                            render={({ field }) => (
                                                                <FormItem>
                                                                    ...
                                                                    <AlertersTextArea
                                                                            ...
                                                                            value={field.value}       // controlled
                                                                            onChange={field.onChange} // propagate correctly
                                                                            placeholder="Issue resolved in {_source.kibana.alert.rule.name}"
                                                                        />
                                                                    </FormControl>
                                                                    <FormDescription>
                                                                        This is the HTML message template for alerts. Use Right click to insert Emoji or Placeholders.
