...
import { saveTeamsAlerter } from "@/components/alerters/teams/TeamsService"; // Assurez-vous que cette fonction existe
import { Card, CardContent } from "@/components/ui/card"
import EditButton from "@/components/alerters/ui/EditButton"; // Assurez-vous que ce composant existe
import { TeamsAlerter } from "@/types/alerters"; // Assurez-vous que ce type est défini correctement
...
const type = "teams"; // Définir le type d'alerter
...
export const FormSchema = z.object({
    ...
    "config": z.object({
        ...
        "webhook": z.string().min(1, {
            message: "Webhook URL must be at least 1 characters.",
        }),
        "isAdaptiveCard": z.boolean().default(false).optional(),
...
export default function TeamsAlerterTab({

    initialValues
}: TeamsTabProps) {

    const [alerters, setAlerters] = useState<TeamsAlerter[]>([]);
    const [editAlerter, setEditAlerter] = useState<TeamsAlerter | null>(null);
    ...
    function addTeamsAlerter() {
        setLoading(true);
        const data: TeamsAlerter = {
            name: "Teams",
            type: type,
        ...
        saveTeamsAlerter(data, setAlerters, setEditAlerter);
    ...
    return (
        <>
            {alerters.length > 0 ? (
                                    ...
                                    <Form {...form}   >
                                        ...
                                        <form
                                            onSubmit={form.handleSubmit((data) => {
                                                saveTeamsAlerter(data, setAlerters);
                                                ...
                                                <ScrollArea className="form-wrapper">
                                                    ...
                                                    <div className="flex flex-col gap-4 w-full pr-4 mb-6">
                                                        ...
                                                        <FormField
                                                            ...
                                                            render={({ field }) => (
                                                                <FormItem>
                                                                    <FormLabel>Teams webhook</FormLabel>
                                                                    <FormControl>
                                                        ...
                                                        <FormField
                                                            control={form.control}
                                                            name="config.isAdaptiveCard"
                                                            render={({ field }) => (
                                                                <FormControl>
                                                                    <div className="flex items-center space-x-2">
                                                                        <FormLabel htmlFor="isAdaptiveCard">Use Adaptive Card</FormLabel>
                                                                        <Checkbox
                                                                            id="isAdaptiveCard"
                                                                            checked={field.value}
                                                                            onCheckedChange={field.onChange} // ✅ important
                                                                        />
                                                                    </div>
                                                                </FormControl>
                                                            )}
                                                            ...
                                                            render={({ field }) => (
                                                                <FormItem className="w-full">
                                                                    ...
                                                                    <FormDescription>
                                                                        ...
                                                                        You can use adaptive cards or simple message. <br />
                                                                        See <a href="https://adaptivecards.microsoft.com/designer" className="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">AdaptiveCards designer</a> for more details.
                ...
                <Button className="max-w-[200px] mt-5" variant="outline" onClick={addTeamsAlerter} >
                    <Plus className="mr-2" />
                    Add Teams Alerter
                </Button>
            )}
